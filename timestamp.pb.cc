...
static constexpr const ::_pb::EnumDescriptor* PROTOBUF_NONNULL* PROTOBUF_NULLABLE
    file_level_enum_descriptors_github_2ecom_2faperturerobotics_2ftimestamp_2ftimestamp_2eproto = nullptr;
static constexpr const ::_pb::ServiceDescriptor* PROTOBUF_NONNULL* PROTOBUF_NULLABLE
    file_level_service_descriptors_github_2ecom_2faperturerobotics_2ftimestamp_2ftimestamp_2eproto = nullptr;
const ::uint32_t
    TableStruct_github_2ecom_2faperturerobotics_2ftimestamp_2ftimestamp_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        protodesc_cold) = {
        0x081, // bitmap
        PROTOBUF_FIELD_OFFSET(::timestamp::Timestamp, _impl_._has_bits_),
        4, // hasbit index offset
        PROTOBUF_FIELD_OFFSET(::timestamp::Timestamp, _impl_.time_unix_ms_),
        0,
};

static const ::_pbi::MigrationSchema
    schemas[] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        {0, sizeof(::timestamp::Timestamp)},
};
static const ::_pb::Message* PROTOBUF_NONNULL const file_default_instances[] = {
    &::timestamp::_Timestamp_default_instance_._instance,
};
const char descriptor_table_protodef_github_2ecom_2faperturerobotics_2ftimestamp_2ftimestamp_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    protodesc_cold) = {
    "\n5github.com/aperturerobotics/timestamp/"
    "timestamp.proto\022\ttimestamp\"!\n\tTimestamp\022"
    "\024\n\014time_unix_ms\030\001 \001(\004b\006proto3"
};
static ::absl::once_flag descriptor_table_github_2ecom_2faperturerobotics_2ftimestamp_2ftimestamp_2eproto_once;
PROTOBUF_CONSTINIT const ::_pbi::DescriptorTable descriptor_table_github_2ecom_2faperturerobotics_2ftimestamp_2ftimestamp_2eproto = {
    false,
    false,
    109,
    descriptor_table_protodef_github_2ecom_2faperturerobotics_2ftimestamp_2ftimestamp_2eproto,
    "github.com/aperturerobotics/timestamp/timestamp.proto",
    &descriptor_table_github_2ecom_2faperturerobotics_2ftimestamp_2ftimestamp_2eproto_once,
    nullptr,
    0,
    1,
    schemas,
    file_default_instances,
    TableStruct_github_2ecom_2faperturerobotics_2ftimestamp_2ftimestamp_2eproto::offsets,
    file_level_enum_descriptors_github_2ecom_2faperturerobotics_2ftimestamp_2ftimestamp_2eproto,
    file_level_service_descriptors_github_2ecom_2faperturerobotics_2ftimestamp_2ftimestamp_2eproto,
};
namespace timestamp {
// ===================================================================
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:timestamp.Timestamp)
}
Timestamp::Timestamp(
...
constexpr auto Timestamp::InternalGenerateClassData_() {
  return ::google::protobuf::internal::ClassDataFull{
      ...
      &descriptor_table_github_2ecom_2faperturerobotics_2ftimestamp_2ftimestamp_2eproto,
      nullptr,  // tracker
  };
}
...
Timestamp::_table_ = {
  {
    ...
    ::_pbi::TcParser::GetTable<::timestamp::Timestamp>(),  // to_prefetch
    #endif  // PROTOBUF_PREFETCH_PARSE_TABLE
  }, {{
    // uint64 time_unix_ms = 1;
    {::_pbi::TcParser::SingularVarintNoZag1<::uint64_t, offsetof(Timestamp, _impl_.time_unix_ms_), 0>(),
     {8, 0, 0,
      PROTOBUF_FIELD_OFFSET(Timestamp, _impl_.time_unix_ms_)}},
  }}, {{
    65535, 65535
  }}, {{
    // uint64 time_unix_ms = 1;
    {PROTOBUF_FIELD_OFFSET(Timestamp, _impl_.time_unix_ms_), _Internal::kHasBitsOffset + 0, 0, (0 | ::_fl::kFcOptional | ::_fl::kUInt64)},
  }},
  // no aux_entries
  {{
  }},
...
// @@protoc_insertion_point(message_clear_start:timestamp.Timestamp)
  ...
  _impl_.time_unix_ms_ = ::uint64_t{0u};
...
::uint8_t* PROTOBUF_NONNULL Timestamp::_InternalSerialize(
  ...
  if (CheckHasBit(cached_has_bits, 0x00000001U)) {
    if (this_._internal_time_unix_ms() != 0) {
      target = stream->EnsureSpace(target);
      target = ::_pbi::WireFormatLite::WriteUInt64ToArray(
          1, this_._internal_time_unix_ms(), target);
    }
  }
...
void Timestamp::MergeImpl(::google::protobuf::MessageLite& to_msg,
  ...
  if (CheckHasBit(cached_has_bits, 0x00000001U)) {
    if (from._internal_time_unix_ms() != 0) {
      _this->_impl_.time_unix_ms_ = from._impl_.time_unix_ms_;
    }
  }
...
void Timestamp::InternalSwap(Timestamp* PROTOBUF_RESTRICT PROTOBUF_NONNULL other) {
  ...
  swap(_impl_.time_unix_ms_, other->_impl_.time_unix_ms_);
}
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::std::false_type
    _static_init2_ [[maybe_unused]] =
        (::_pbi::AddDescriptors(&descriptor_table_github_2ecom_2faperturerobotics_2ftimestamp_2ftimestamp_2eproto),
         ::std::false_type{});
